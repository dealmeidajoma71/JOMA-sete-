...
// ==================================================
// RJ7 COLOR MATCH — CORES REAIS DO SUPABASE
// ==================================================

const rj7ColorOptions =
    document.getElementById(
        "rj7ColorOptions"
    );
...
if (rj7ColorOptions) {
    ...
    allButton.className =
        "rj7-color-option active";

    allButton.dataset.colorMatch =
        "all";

    allButton.innerHTML = `
        <span class="rj7-color-circle all"></span>
        <span>ALL</span>
    `;

    rj7ColorOptions.appendChild(
        allButton
    );


    // ----------------------------------------------
    // CORES REAIS DO SUPABASE
    // ----------------------------------------------
...
else if (colorName === "amarelo") {
    visualColor = "yellow";
}

else if (colorName === "laranja") {
    visualColor = "orange";
}

else if (colorName === "roxo") {
    visualColor = "purple";
}
...
else if (colorName === "castanho") {
    visualColor = "brown";
}

else if (colorName === "bege") {
    visualColor = "beige";
}
...
button.innerHTML = `
    <span
        class="rj7-color-circle ${visualColor}"
        data-rj7-color="${color}"
    ></span>
...
// ======================================================
// RJ7 — MAPA DE CORES DA LOJA → CORES DAS VARIANTES
// ======================================================
...
async function loadAllProductVariants() {
    ...
    if (error) {
        ...
        console.error(
            "RJ7 — erro ao carregar todas as variantes:",
            error
        );
    ...
    console.log(
        "RJ7 — variantes associadas aos produtos:",
        products
    );
